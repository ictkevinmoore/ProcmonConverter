...
function New-ReportHTML {
    ...
    try {
        ...
        # Data Visualizations Section (Moved to top)
        ...
        $htmlBuilder.AppendLine('                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#processChartModal">') | Out-Null
        $htmlBuilder.AppendLine('                            <i class="fas fa-chart-bar me-2"></i>Process Distribution') | Out-Null
        $htmlBuilder.AppendLine('                        </button>') | Out-Null
        $htmlBuilder.AppendLine('                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#operationChartModal" style="background-color: var(--accent-orange); border-color: var(--accent-orange);">') | Out-Null
        $htmlBuilder.AppendLine('                            <i class="fas fa-chart-pie me-2"></i>Operation Distribution') | Out-Null
        $htmlBuilder.AppendLine('                        </button>') | Out-Null
        $htmlBuilder.AppendLine('                    </div>') | Out-Null
        $htmlBuilder.AppendLine('                </div>') | Out-Null
        $htmlBuilder.AppendLine('            </div>') | Out-Null
