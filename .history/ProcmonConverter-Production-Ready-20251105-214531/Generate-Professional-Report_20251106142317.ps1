...
C:\Users\ictke\OneDrive\Desktop\November Script Back-up\ProcmonConverter-Production-Ready-20251105-214531
<#
.SYNOPSIS
...
function New-ReportHTML {
    ...
    try {
        ...
        $processedDataForAnalytics = @{
            ...
            Statistics = @{
                ProcessTypes = $ReportData.Summary.ProcessTypes
                Operations = $ReportData.Summary.Operations
                Results = @{}
            }
        }
        ...
        foreach ($cluster in $patterns.ProcessClusters) {
            ...
            $htmlBuilder.AppendFormat('                                        <div class="label">{0} Activity Processes</div>', $cluster.Category) | Out-Null
